      ...
      <div className="relative h-full overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className={`${s.title} font-medium truncate leading-tight flex items-center gap-1.5`} style={{ color: isCurrent ? accentColor : 'rgba(255,255,255,0.9)' }}>
            ...
            <p className={`${s.meta} text-white/40 truncate leading-tight mt-0.5`}>
